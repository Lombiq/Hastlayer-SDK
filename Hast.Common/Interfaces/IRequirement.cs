...
{
    /// <summary>
    /// Represents a type which has requirements of the same type. For example service implementation that expects
    /// certain other implementations of the same service to be run before it.
    /// </summary>
