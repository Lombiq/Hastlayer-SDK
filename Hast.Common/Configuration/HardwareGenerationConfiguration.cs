...
public class HardwareGenerationConfiguration : IHardwareGenerationConfiguration
{
    ...
    /// be logged or saved during hardware generation but otherwise it may not used in any activities.
    /// </summary>
    public string Label { get; set; }

    /// <summary>
    /// Gets the collection of the full name of those public members that will be accessible as hardware implementation.
    /// By default all members implemented from interfaces and all public virtual members will be included. You can use
    /// this to restrict what gets transformed into hardware; if nothing is specified all suitable members will be
    /// transformed.
    /// </summary>
    /// <example>
    /// <para>
    ...
    /// implementation. By default all members implemented from interfaces and all public virtual members will be
    /// included. You can use this to restrict what gets transformed into hardware; if nothing is specified all suitable
    /// members will be transformed.
    /// </summary>
    /// <example>
    ...
    /// <summary>
    /// Gets or sets a value indicating whether hardware transformation takes place. If it doesn't then <see
    /// cref="EnableHardwareImplementationComposition"/> will be implied to be <see langword="false"/> too. Defaults to
    /// <see langword="true"/>.
    /// </summary>
    public bool EnableHardwareTransformation { get; set; } = true;

    /// <summary>
    /// Gets or sets a value indicating whether a hardware implementation composer should be used to synthesize hardware
    /// from the transformed hardware description. Defaults to <see langword="true"/>.
    /// </summary>
    ...
    /// The name of the FPGA device (board) to transform for. Device-specific configurations are determined by device
    /// drivers. You can fetch the list of supported devices via <c>IHastlayer.GetSupportedDevices()</c>.
    /// </param>
