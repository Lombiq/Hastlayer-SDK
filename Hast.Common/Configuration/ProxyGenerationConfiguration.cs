...
{
    /// <summary>
    /// Gets a dictionary that can contain settings for non-default configuration options (like the name of the
    ...
    /// <summary>
    /// Gets or sets a value indicating whether the results coming from the hardware implementation should be checked
    /// against a software execution. If set to <see langword="true"/> then both a hardware and software invocation will
    /// happen and the result of the two compared. If there is a mismatch then an exception will be thrown.
    /// </summary>
