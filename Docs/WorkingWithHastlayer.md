...
- Method inlining with the `[MethodImpl(MethodImplOptions.AggressiveInlining)]` attribute as usual in .NET is supported. It's recommended to inline small methods to cut down on the overhead of method calls.
