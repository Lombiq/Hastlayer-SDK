...
namespace Hast.Communication.Extensibility
{
    ...
    public interface IMemberInvocationContext
    {
        ...
        /// <summary>
        /// Gets the debug information about the software execution of hardware-executed members in case the hardware execution was canceled or verified in software.
        /// </summary>
