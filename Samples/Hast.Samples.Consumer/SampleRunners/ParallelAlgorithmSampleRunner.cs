...
namespace Hast.Samples.Consumer.SampleRunners
{
    internal static class ParallelAlgorithmSampleRunner
    {
        ...
        public static async Task Run(IHastlayer hastlayer, IHardwareRepresentation hardwareRepresentation)
        {
            ...
            // 200ms (including communication latency). Compiling that hardware design will take about 14.5 hours 
            // though (with MaxDegreeOfParallelism 600 it'll take about 4).
