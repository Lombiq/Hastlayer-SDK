    ...
    public class ImageContrastModifier
    {
        ...
        public virtual void ChangeContrast(SimpleMemory memory)
        {
            ...
            for (int i = 0; i < stepCount; i++)
            {
                ...
                {
                    var pixelBytes = memory[i * MaxDegreeOfParallelism + t + ChangeContrast_ImageStartIndex];
                    ...
                    new PixelProcessingTaskInput { PixelBytes = pixelBytes.ToArray(), ContrastValue = contrastValue });
                }
