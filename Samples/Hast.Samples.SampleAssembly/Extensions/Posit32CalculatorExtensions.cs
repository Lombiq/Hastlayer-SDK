    ...
    public static class Posit32CalculatorExtensions
    {
            ...
            IHardwareGenerationConfiguration configuration = null)
        {
            ...
            return (float)new Posit32(
                memory.ReadUInt32(Posit32Calculator.CalculatePowerOfRealOutputPosit32Index),
                true);
        }
            ...
            IHardwareGenerationConfiguration configuration = null)
        {
            ...
            {
                memory.WriteInt32(
                    Posit32Calculator.ParallelizedCalculateLargeIntegerSumInt32NumbersStartIndex + i,
                    numbers[i]);
            }
            ...
            {
                results[i] =
                    memory.ReadInt32(Posit32Calculator.ParallelizedCalculateLargeIntegerSumOutputInt32sStartIndex + i);
            }
