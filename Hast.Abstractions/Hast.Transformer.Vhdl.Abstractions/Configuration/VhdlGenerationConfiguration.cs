namespace Hast.Transformer.Vhdl.Abstractions.Configuration
{
    ...
    {
        /// <summary>
        /// Gets the configuration where the generated VHDL code will be more readable and will contain debug-level information, though it will be
        ...
        /// <summary>
        /// Gets the configuration where the generated VHDL code will have the smallest possible size and be more readable due to shortened
        ...
        /// <summary>
        /// Gets the configuration where the generated VHDL code will be significantly faster to create than in <see cref="Debug"/> or
