...
//        bit 1  - Channel 1 (ap_ready)
//        others - reserved
// 0x10 : Data signal of axi00_ptr0
//        bit 31~0 - axi00_ptr0[31:0] (Read/Write)
// 0x14 : Data signal of axi00_ptr0
...
localparam
    ...
    ADDR_IER               = 5'h08,
    ADDR_ISR               = 5'h0c,
    ADDR_AXI00_PTR0_DATA_0 = 5'h10,
    ADDR_AXI00_PTR0_DATA_1 = 5'h14,
    ADDR_AXI00_PTR0_CTRL   = 5'h18,
    WRIDLE                 = 2'd0,
    WRDATA                 = 2'd1,
    WRRESP                 = 2'd2,
    WRRESET                = 2'd3,
...
always @(negedge ACLK) begin
  if (1) begin // 1 - enabled / 0 - disabled
    if (w_hs) $display("%0d: write: addr = %x, data = %x", $time, waddr, WDATA);
    if (ar_hs) $display("%0d: read: addr = %x", $time, raddr);
  end
end
