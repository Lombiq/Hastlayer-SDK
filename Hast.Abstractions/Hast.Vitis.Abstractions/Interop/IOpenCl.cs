...
{
    /// <summary>
    /// ADL Interoperability interface for the OpenCL native library. The method documentation is
    /// copied from source as-is <see href="https://www.khronos.org/registry/OpenCL/sdk/1.0/docs/man/xhtml/"/>.
    /// </summary>
    ...
    public interface IOpenCl : IDisposable
    {
        ...
        /// The number of cl_platform_id entries that can be added to platforms. If platforms is not
        ...
        /// NULL, this argument is ignored. The number of OpenCL platforms returned is the mininum
        /// of the value specified by num_entries or the number of OpenCL platforms available.
        /// </param>
        /// <param name="numberOfPlatforms">
        /// Returns the number of OpenCL platforms available. If num_platforms is NULL, this
        /// argument is ignored.
        /// </param>
        ...
        /// </summary>
        /// <param name="platform">
        /// The platform ID returned by clGetPlatformIDs or can be NULL. If platform is NULL, the
        /// behavior is implementation-defined.
        /// </param>
        /// <param name="parameterName">
        /// An enumeration constant that identifies the platform information being queried. It can
        /// be one of the following values as specified in the table below.
        /// </param>
        /// <param name="parameterValueSize">
        /// Specifies the size in bytes of memory pointed to by param_value. This size in bytes must
        /// be greater than or equal to size of return type specified in the table below.
        /// </param>
        /// <param name="parameterValue">
        /// A pointer to memory location where appropriate values for a given param_value will be
        /// returned. Acceptable param_value values are listed in the table below. If param_value is
        /// NULL, it is ignored.
        /// </param>
        ...
        /// </summary>
        /// <param name="platform">
        /// Refers to the platform ID returned by clGetPlatformIDs or can be NULL. If platform is
        ...
        /// </param>
        /// <param name="numberOfEntries">
        /// The number of cl_device entries that can be added to devices. If devices is not NULL,
        /// the num_entries must be greater than zero.
        /// </param>
        /// <param name="devices">
        /// A list of OpenCL devices found. The cl_device_id values returned in devices can be used
        /// to identify a specific OpenCL device. If devices argument is NULL, this argument is
        /// ignored. The number of OpenCL devices returned is the mininum of the value specified by
        ...
        /// Specifies a list of context property names and their corresponding values. Each property
        /// name is immediately followed by the corresponding desired value. The list is terminated
        /// with 0. properties can be NULL in which case the platform that is selected is
        /// implementation-defined. The list of supported properties is described in the table below.
        /// </param>
        ...
        /// will be used by the OpenCL implementation to report information on errors that occur in
        /// this context. This callback function may be called asynchronously by the OpenCL
        ...
        /// <param name="device">
        /// Must be a device associated with context. It can either be in the list of devices
        /// specified when context is created using clCreateContext or have the same device type as
        /// the device type specified when the context is created using clCreateContextFromType.
        /// </param>
        /// <param name="propertieses">
        /// Specifies a list of properties for the command-queue. This is a bit-field. Only
        /// command-queue properties specified in the table below can be set in properties;
        /// otherwise the value specified in properties is considered to be not valid.
        /// </param>
        /// <param name="errorCode">
        /// Returns an appropriate error code. If errcode_ret is NULL, no error code is returned.
        /// </param>
        ...
        /// The number of devices listed in device_list. The devices associated with the program
        /// object will be the list of devices specified by device_list. The list of devices
        /// specified by device_list must be devices associated with context.
        /// </param>
        /// <param name="lengths">
        ...
        /// device_list. For each device given by device_list[i], the pointer to the program binary
        /// for that device is given by binaries[i] and the length of this corresponding binary is
        /// given by lengths[i]. lengths[i] cannot be zero and binaries[i] cannot be a NULL pointer.
        /// The program binaries specified by binaries contain the bits that describe the program
        /// executable that will be run on the device(s) associated with context. The program binary
        /// can consist of either or both of device-specific executable(s), and/or
        ...
        /// is not a valid binary for the specified device. If binary_status is NULL, it is ignored.
        /// </param>
        /// <param name="errorCode">
        /// Returns an appropriate error code. If errcode_ret is NULL, no error code is returned.
        /// </param>
        ...
        /// <param name="numberOfDevices">
        /// A pointer to a list of devices that are in program. If device_list is NULL value, the
        /// program executable is built for all devices associated with program for which a source
        /// or binary has been loaded. If device_list is a non-NULL value, the program executable is
        /// built for devices specified in this list for which a source or binary has been loaded.
        /// </param>
        /// <param name="deviceList">The number of devices listed in device_list.</param>
        /// <param name="options">
        /// A pointer to a string that describes the build options to be used for building the
        /// program executable. The list of supported options is described in "Build Options" below.
        /// </param>
        /// <param name="notify">
        ...
        /// executable has been built (successfully or unsuccessfully). If pfn_notify is not NULL,
        /// clBuildProgram does not need to wait for the build to complete and can return
        /// immediately. If pfn_notify is NULL, clBuildProgram does not return until the build has
        /// completed. This callback function may be called asynchronously by the OpenCL
        /// implementation. It is the application's responsibility to ensure that the callback
        ...
        /// is the size of the buffer or image object type. For arguments declared with the __local
        /// qualifier, the size specified will be the size in bytes of the buffer that must be
        /// allocated for the __local argument. If the argument is of type sampler_t, the arg_size
        /// value must be equal to sizeof(cl_sampler). For all other arguments, the size will be the
        /// size of argument type.
        /// </param>
        /// <param name="argumentValue">
        /// A pointer to data that should be used as the argument value for argument specified by
        /// arg_index. The argument data pointed to by arg_value is copied and the arg_value pointer
        /// can therefore be reused by the application after clSetKernelArg returns. The argument
        /// value specified is the value used by all API calls that enqueue kernel
        /// (clEnqueueNDRangeKernel and clEnqueueTask) until the argument value is changed by a call
        ...
        /// <param name="memoryMigrationFlagses">
        ...
        /// event_wait_list is NULL, then this particular command does not wait on any event to
        ...
        /// Returns an event object that identifies this particular command and can be used to query
        /// or queue a wait for this particular command to complete. event can be NULL in which case
        /// it will not be possible for the application to query the status of this command or queue
        /// a wait for this command to complete. If the event_wait_list and the event arguments are
        /// not NULL, the event argument should not refer to an element of the event_wait_list array.
        /// </param>
        ...
        /// </summary>
        /// <param name="commandQueue">
        /// A valid command-queue. The kernel will be queued for execution on the device associated
        /// with command_queue.
        /// </param>
        /// <param name="kernel">
        /// A valid kernel object. The OpenCL context associated with kernel and command_queue must
        /// be the same.
        /// </param>
        /// <param name="numberOfEventsInWaitList">The length of <paramref name="eventWaitList"/>.</param>
        /// <param name="eventWaitList">
        ...
        /// </param>
        /// <param name="waitEvent">
        /// Returns an event object that identifies this particular kernel execution instance. Event
        /// objects are unique and can be used to identify a particular kernel execution instance
        /// later on. If event is NULL, no event will be created for this kernel execution instance
        /// and therefore it will not be possible for the application to query or queue a wait for
