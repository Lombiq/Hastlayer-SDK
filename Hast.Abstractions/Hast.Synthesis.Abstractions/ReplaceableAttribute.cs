...
/// replacement according to custom configuration) will be substituted at runtime the same way constants are substituted
/// in during compile time. See the "Using dynamic constants" section in "Docs/WorkingWithHastlayer.md" for further
