...
/// <summary>
/// A very simple pseudo random number generator implemented with a <see
/// href="https://en.wikipedia.org/wiki/Linear_feedback_shift_register">linear-feedback shift register</see>. Use this
/// if you want simple but fast PRNG with the least resources. For a PRNG that has better quality but higher resource
/// usage see <see cref="RandomMwc64X"/>.
/// </summary>
public class RandomLfsr
{
    /// <summary>
    /// Gets or sets the current inner state of the random number generator. If you set it when instantiating the object
    /// then it'll serve as a seed.
    /// </summary>
    /// <remarks>
