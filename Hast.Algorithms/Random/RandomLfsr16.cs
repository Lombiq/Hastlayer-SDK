...
/// <summary>
/// The same linear-feedback shift register pseudo random number generator as in <see cref="RandomLfsr"/> but with a 16b
/// state. For details check out the documentation on the other implementation.
/// </summary>
