...
- ✅ 01-toolchain-and-submodule-baseline: Align the SDK, submodules, and shared upgrade baseline ([Content](tasks/01-toolchain-and-submodule-baseline/task.md), [Progress](tasks/01-toolchain-and-submodule-baseline/progress-details.md))
- ✅ 02-console-and-vitis-stack: Upgrade the console entry point and the Vitis/Xilinx dependency slice ([Content](tasks/02-console-and-vitis-stack/task.md), [Progress](tasks/02-console-and-vitis-stack/progress-details.md))
- 🔄 02-console-and-vitis-stack: Upgrade the console entry point and the Vitis/Xilinx dependency slice ([Content](tasks/02-console-and-vitis-stack/task.md))
