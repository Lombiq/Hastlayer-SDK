...
namespace Hast.Samples.Posit
{
    ...
    public static class Posit16_3_CalculatorCalculatorExtensions
    {
        public static int CalculateIntegerSumUpToNumber(
            this  Posit16_3_Calculator  positCalculator,
            int number,
            ...
            IHardwareGenerationConfiguration configuration = null)
        {
            ...
            var memory = hastlayer is null
                ? SimpleMemory.CreateSoftwareMemory(Posit16_3_Calculator.MaxDegreeOfParallelism)
                : hastlayer.CreateMemory(configuration, Posit16_3_Calculator.MaxDegreeOfParallelism);
