...
namespace Hast.Samples.Posit
{
    ...
    public static class Posit8_4_CalculatorCalculatorExtensions
    {
        public static int CalculateIntegerSumUpToNumber(
            this  Posit8_4_Calculator  positCalculator,
            int number,
            ...
            IHardwareGenerationConfiguration configuration = null)
        {
            ...
            var memory =  var memory = hastlayer is null
                ? SimpleMemory.CreateSoftwareMemory(Posit8_4_Calculator.MaxDegreeOfParallelism)
                : hastlayer.CreateMemory(configuration, Posit8_4_Calculator.MaxDegreeOfParallelism));
