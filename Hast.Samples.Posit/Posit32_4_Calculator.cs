...
namespace Hast.Samples.Posit
{
    ...
    public static class Posit32_4_CalculatorCalculatorExtensions
    {
        public static int CalculateIntegerSumUpToNumber(
            this  Posit32_4_Calculator  positCalculator,
            int number,
            ...
            IHardwareGenerationConfiguration configuration = null)
        {
            ...
            var memory = hastlayer is null
                ? SimpleMemory.CreateSoftwareMemory(Posit32_4_Calculator.MaxDegreeOfParallelism)
                : hastlayer.CreateMemory(configuration, Posit32_4_Calculator.MaxDegreeOfParallelism);
