...
namespace Hast.Samples.Posit
{
    ...
    public static class Posit16_4_CalculatorCalculatorExtensions
    {
        public static int CalculateIntegerSumUpToNumber(
            this  Posit16_4_Calculator  positCalculator,
            int number,
            ...
            IHardwareGenerationConfiguration configuration = null)
        {
            ...
            var memory = hastlayer is null
                ? SimpleMemory.CreateSoftwareMemory(Posit16_4_Calculator.MaxDegreeOfParallelism)
                : hastlayer.CreateMemory(configuration, Posit16_4_Calculator.MaxDegreeOfParallelism);
