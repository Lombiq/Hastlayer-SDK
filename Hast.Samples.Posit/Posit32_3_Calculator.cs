...
namespace Hast.Samples.Posit
{
    ...
    {
        public static int CalculateIntegerSumUpToNumber(this  Posit32_3_Calculator  positCalculator, int number)
        {
        ...
        public static IEnumerable<int> ParallelizedCalculateIntegerSumUpToNumbers(this  Posit32_3_Calculator positCalculator, int[] numbers)
        {
            ...
            var memory = new SimpleMemory( Posit32_3_Calculator.MaxDegreeOfParallelism);
        ...
        public static float AddPositsInArray(this  Posit32_3_Calculator positCalculator, uint[] positArray)
        {
