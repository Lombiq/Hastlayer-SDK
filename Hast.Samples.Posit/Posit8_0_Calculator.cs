...
namespace Hast.Samples.Posit
{
    ...
    public static class Posit8_0_CalculatorCalculatorExtensions
    {
        public static int CalculateIntegerSumUpToNumber(
            this  Posit8_0_Calculator  positCalculator,
            int number,
            ...
            IHardwareGenerationConfiguration configuration = null)
        {
            ...
            var memory = hastlayer is null
                ? SimpleMemory.CreateSoftwareMemory(Posit8_0_Calculator.MaxDegreeOfParallelism)
                : hastlayer.CreateMemory(configuration, Posit8_0_Calculator.MaxDegreeOfParallelism);
