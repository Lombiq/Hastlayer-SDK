...
namespace Hast.Samples.Posit
{
    ...
    public static class Posit16_2_CalculatorCalculatorExtensions
    {
        public static int CalculateIntegerSumUpToNumber(
            this  Posit16_2_Calculator  positCalculator,
            int number,
            ...
            IHardwareGenerationConfiguration configuration = null)
        {
            ...
            var memory =  var memory = hastlayer is null
                ? SimpleMemory.CreateSoftwareMemory(Posit16_2_Calculator.MaxDegreeOfParallelism)
                : hastlayer.CreateMemory(configuration, Posit16_2_Calculator.MaxDegreeOfParallelism));
