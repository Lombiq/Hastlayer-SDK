...
namespace Hast.Samples.Posit
{
    ...
    public static class Posit16_0_CalculatorCalculatorExtensions
    {
            ...
            IHardwareGenerationConfiguration configuration = null)
        {
            ...
            var memory = hastlayer is null
                ? SimpleMemory.CreateSoftwareMemory(Posit16_0_Calculator.MaxDegreeOfParallelism)
                : hastlayer.CreateMemory(configuration, Posit16_0_Calculator.MaxDegreeOfParallelism);
